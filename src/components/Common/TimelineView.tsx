...
export function TimelineView({ tasks, onEdit, highlightedTaskId, onStatusChange }: TimelineViewProps) {
    ...
    const renderUpcomingTimeline = (taskList: Task[]) => {
        const now = new Date();
        ...
        taskList.forEach((task) => {
            ...
            // Render Now Line if transitioning from expired to future, or if first item is future
        ...
        // If no future tasks found, show Now line at the end
    ...
    return (
        <div className="space-y-8 pl-4 border-l-2 border-primary/20 ml-2 md:ml-4">
            ...
            {upcomingTasks.length > 0 ? (
                renderUpcomingTimeline(upcomingTasks)
            ) : (
